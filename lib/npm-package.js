...
class NpmPackage {
	...
	//-- Validate
	validate({ cwd = process.cwd(), scope, js, json, yaml, bash, editorconfig, scss, ignore = [] } = {}) {
	...
	validateMulti({ cwd = process.cwd(), js = patterns.js, json = patterns.json, yaml = patterns.yaml, bash = patterns.bash, editorconfig = patterns.editorconfig, scss } = {}) {
	...
	validateSub({ cwd = process.cwd(), js, json, yaml, bash, editorconfig, scss } = {}) {
		const options = getOptions({
			cwd:          cwd,
